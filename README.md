...
<img src="p1.jpg" alt="Preview del Submod" width="700" style="border-radius: 10px;"/>
...
* **Soporte para Submod Updater Plugin:** Recibe avisos y actualiza el submod directamente desde el menú del juego sin configuraciones complicadas. (Solo disponible en versión 1.5.0 o superior)
...
* Este submod surgió dentro de la comunidad de **Encoders Club**. Únete a su servidor de Discord aquí: **[Discord de Encoders Club](https://discord.gg/UHFQS2CQe)**.
